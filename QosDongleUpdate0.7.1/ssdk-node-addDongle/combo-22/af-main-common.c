...
static uint8_t s_bFtaDisablePermitJoin = false;
...
{
  if (s_bFtaDisablePermitJoin)
  {
    duration = 0;
    broadcastMgmtPermitJoin = false;
  }
...
void afMainCommon_DisablePermitJoin(void)
{
  s_bFtaDisablePermitJoin = true;
}
