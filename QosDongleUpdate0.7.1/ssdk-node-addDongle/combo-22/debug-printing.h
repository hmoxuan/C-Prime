...
#if defined (CWP_NODE)
#define emberAfBasicClusterPrint    log_Printfbasic
#define emberAfBasicClusterPrintln  log_Printfbasic
...
#if defined (CWP_NODE)
#define emberAfOtaBootloadClusterPrint          log_Printfbasic
#define emberAfOtaBootloadClusterPrintln        log_Printfbasic
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfOtaBootloadClusterFlush()
#define emberAfOtaBootloadClusterDebugExec(x)
#define emberAfOtaBootloadClusterPrintBuffer(buffer, len, withSpace) dump_buf( buffer, len)
#define emberAfOtaBootloadClusterPrintString    log_Printfbasic
#elif defined (CWP_DONGLE)
...
#if defined (CWP_NODE)
#define emberAfCorePrint    log_PrintfCustom
#define emberAfCorePrintln  log_Printfbasic
#define emberAfCoreFlush()
#define emberAfCoreDebugExec(x) do { x; }while(0);
#define emberAfCorePrintBuffer(buffer, len, withSpace) dump_buf(buffer, len)
...
#if defined (CWP_NODE)
#define emberAfDebugPrint           log_PrintfCustom
#define emberAfDebugPrintln         log_Printfbasic
...
#if defined (CWP_NODE)
#define emberAfAppPrint         log_PrintfCustom
#define emberAfAppPrintln       log_Printfbasic
#define emberAfAppFlush()       log_PrintfCustom("\r")
...
#if defined (CWP_NODE)
#define emberAfZdoPrint         log_Printfbasic
#define emberAfZdoPrintln       log_Printfbasic
